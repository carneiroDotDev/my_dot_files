...
autocmd BufNewFile  *.jade  call    Generate_jade()

function! Generate_jade()
    call append(0,  'doctype html')
    call append(1,  'html(lang="en")')
    call append(2,  ' head')
    call append(3,  '   meta(charset="UTF-8")')
    call append(4,  '   meta(name="author" content="Luiz Carneiro")')
    call append(5,  '   //- link(rel="stylesheet" ')
    call append(6,  '   //- href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css"')
    call append(7,  '   //- integrity="sha384-/Y6pD6FV/Vv2HJnA6t+vslU6fwYXjCFtcEpHbNJ0lyAFsXTsjBbfaDjzALeQsN6M"')
    call append(8,  '   //- crossorigin="anonymous")')
    call append(9,  '   link(type="text/css" rel="stylesheet" href="style.css")')
    call append(10, '   title Page Title')
    call append(11, ' body')
    call append(12, '   h1 Jade - node template engine')
    call append(13, '   #container.col')
    call append(14, '     if youAreUsingJade')
    call append(15, '       p You are amazing')
    call append(16, '     else')
    call append(17, '       p Get on it!')
    call append(18, '     p.')
    call append(19, '       Jade is a terse and simple templating language with a')
    call append(20, '       strong focus on performance and powerful features.')
    call append(21, '   //- script(src="https://code.jquery.com/jquery-3.2.1.slim.min.js"')
    call append(22, '   //- integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN"')
    call append(23, '   //- crossorigin="anonymous")')
    call append(24, '   //- script(src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js"')
    call append(25, '   //- integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4"')
    call append(26, '   //- crossorigin="anonymous")')
    call append(27, '   //- script(src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/js/bootstrap.min.js"')
    call append(28, '   //- integrity="sha384-h0AbiXch4ZDo7tp9hKZ4TsHbi047NrKGLO3SEJAg45jXxnGIfYzk4Si90RDIqNm1"')
    call append(29, '   //- crossorigin="anonymous")')
    call append(30, '   //- script(type="text/javascript").') 
endfunction
